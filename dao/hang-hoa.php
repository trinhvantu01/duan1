...
function hang_hoa_select_page()
{
    ...
    if (!isset($_SESSION['page_count'])) {
        ...
        $_SESSION['page_count'] = ceil($row_count / $item_per_page);
    }
    ...
    $offset = $_SESSION['page_no'] * $item_per_page;
    $sql = "SELECT * FROM hang_hoa ORDER BY ma_hh LIMIT " . $offset . ", " . $item_per_page;
    return pdo_query($sql);
}
